...
/* ----------------------------------------------------------------------------------------------------------
	...
	Grab a list of courses you need to publish. 
	The easiest way is probably to just pull a provisioning report 	(http://guides.instructure.com/m/4214/l/80121-what-reports-are-available-at-the-account-level),	Report #4 in that example. 
	...
	Call the function and pass the array, the event, and either the word "production" or "beta" depending on where you want to publish.
		...
		Events can be (per the API documentation)
			...
			any possibility the course will be used again.) The recovered course will be unpublished. Deleted enrollments will not be recovered.
